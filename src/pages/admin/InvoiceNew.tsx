...
export default function InvoiceNew() {
  ...
  // Fetch proposal data if proposal_id is in URL
  ...
  // Pre-fill form data from proposal when proposal is loaded
  useEffect(() => {
        ...
        <div className="flex items-center space-x-4">
          ...
          <div>
            ...
            <p className="text-sm text-gray-600 mt-1">
              {proposal ? `Creating invoice from proposal ${proposal.proposal_number}` : 'Create a new invoice'}
            </p>
          </div>
        </div>
