      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-0">
          ...
          <div className="flex flex-col gap-3 sm:gap-4">
            <div className="flex items-start sm:items-center justify-between gap-3">
              <div className="flex items-center space-x-2 sm:space-x-4 min-w-0 flex-1">
                <button onClick={() => navigate('/admin/invoices')} className="text-gray-600 hover:text-gray-900 flex-shrink-0 touch-manipulation">
                ...
                <div className="flex flex-col sm:flex-row items-stretch sm:items-center gap-2 sm:gap-3 flex-shrink-0">
                  <div className="flex items-center space-x-2">
                    ...
                    <select
                      ...
                      className="px-3 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-teal-500 focus:border-transparent text-xs sm:text-sm touch-manipulation bg-white min-w-[120px]"
                    >
            ...
            {/* Action Buttons - Cancel and Update/Create */}
            <div className="flex flex-col sm:flex-row items-stretch sm:items-center justify-end gap-3 sm:gap-4 pt-2 border-t border-gray-200">
              <button
                type="button"
        ...
        <div className="flex flex-col lg:flex-row gap-6">
          ...
          <div className="flex-1 min-w-0 space-y-4 sm:space-y-6">
            <form id="invoice-form" onSubmit={handleSubmit} className="bg-white rounded-lg shadow-sm border border-gray-200 p-4 sm:p-6 space-y-4 sm:space-y-6">
            ...
            {formData.invoice_type === 'confirmed' && (
              <div>
                ...
                <input
                  ...
                  placeholder="e.g., 18"
                />
                <p className="mt-1 text-xs text-gray-500">Enter the GST percentage rate (e.g., 18 for 18%)</p>
              </div>
            )}
