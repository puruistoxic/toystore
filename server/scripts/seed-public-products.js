...
const CATALOG = [
  {
    ...
    seo_title: 'Baby Piano Fitness Rack Play Mat | Manku Toys | Khandelwal Toy Store',
    seo_description:
      'Baby piano fitness rack with play mat, arch toys, and kick piano. Early development baby gym from Manku Toys.',
    seo_keywords: JSON.stringify(['baby gym', 'play mat', 'kick piano', 'Manku', 'infant toys', 'toy store']),
  },
  {
    ...
    warranty: 'As per manufacturer',
    seo_title: 'My Magical Unicorn Hopscotch Set | Indoor Active Play | Khandelwal Toy Store',
    seo_description:
      'Unicorn hopscotch ring set with spinner for kids 5+. Custom paths for active indoor play.',
    seo_keywords: JSON.stringify(['hopscotch', 'unicorn toy', 'active play', 'Manku', 'toy shop']),
  },
  {
    ...
    warranty: 'As per manufacturer',
    seo_title: "Maria's Kitchen Doll & Kitchen Set | Manku Toys | Khandelwal Toy Store",
    seo_description:
      "Maria's Kitchen play set with doll and 25+ kitchen accessories for kids 3+.",
    seo_keywords: JSON.stringify(['kitchen set toy', 'doll kitchen', 'Manku', 'role play', 'toy store']),
  },
  {
    ...
    warranty: 'As per manufacturer',
    seo_title: 'Mini World Modern Kitchen Set Toy | Manku | Khandelwal Toy Store',
    seo_description: 'Modern toy kitchen set with appliances and cookware for preschool role play.',
    seo_keywords: JSON.stringify(['kitchen toy', 'play kitchen', 'Manku', 'Mini World', 'toy store']),
  },
  {
    ...
    warranty: 'As per manufacturer',
    seo_title: "Nora's Sweet Home Doll House Set | Manku Toys | Khandelwal Toy Store",
    seo_description:
      "Nora's Sweet Home dollhouse with dolls and furniture for kids 3+.",
    seo_keywords: JSON.stringify(['doll house', 'dollhouse', 'Manku', 'Sweet Home', 'toy store']),
  },
  {
    ...
    warranty: 'As per manufacturer',
    seo_title: 'Space Hip Hop Kids Drum Set | Manku Toys | Khandelwal Toy Store',
    seo_description: 'Space-themed kids drum kit with cymbal and stool for ages 3+.',
    seo_keywords: JSON.stringify(['kids drum', 'musical toy', 'drum set', 'Manku', 'toy store']),
  },
  {
    ...
    warranty: 'As per manufacturer',
    seo_title: 'Twinkle Fashion Beauty Doll Set | Manku Toys | Khandelwal Toy Store',
    seo_description: 'Fashion doll beauty set with accessories and shoes for kids 3+.',
    seo_keywords: JSON.stringify(['fashion doll', 'beauty set', 'Manku', 'Twinkle', 'toy store']),
  },
  {
    ...
    warranty: 'As per manufacturer',
    seo_title: 'Electric Water Gun Splash Blitz KB1501 USB | K.LAL | Khandelwal Toy Store',
    seo_description:
      'Rechargeable electric water gun KB1501 with USB charging and 350 ml tank.',
    seo_keywords: JSON.stringify(['water gun', 'electric water gun', 'Holi', 'K.LAL', 'toy store']),
  },
  {
    ...
    seo_title: 'Pexpo Amaze 800 ml Insulated Bottle | Khandelwal Toy Store',
    seo_description: 'Pexpo Amaze stainless steel insulated water bottle 800 ml.',
    seo_keywords: JSON.stringify(['Pexpo', 'Amaze', 'insulated bottle', '800ml', 'toy store']),
  },
  {
    ...
    warranty: 'As per Pexpo / retailer policy',
    seo_title: 'Pexpo Atlas 1000 ml Insulated Bottle | Khandelwal Toy Store',
    seo_description: 'Pexpo Atlas 1 Litre insulated stainless steel water bottle.',
    seo_keywords: JSON.stringify(['Pexpo', 'Atlas', '1 litre bottle', 'insulated', 'toy store']),
  },
  {
    ...
    seo_title: 'Milton Steel Convey 900 Insulated Bottle | Khandelwal Toy Store',
    seo_description: 'Milton Steel Convey 900 insulated inner steel water bottle.',
    seo_keywords: JSON.stringify(['Milton', 'Steel Convey', 'thermoware', '900ml', 'toy store']),
  },
  {
    ...
    warranty: 'As per Milton India policy',
    seo_title: 'Milton Steel Marble 900 Insulated Bottle | Khandelwal Toy Store',
    seo_description: 'Milton Steel Marble 900 insulated inner steel water bottle.',
    seo_keywords: JSON.stringify(['Milton', 'Steel Marble', 'thermoware', '900ml', 'toy store']),
  },
  {
    filename:
    ...
    warranty: 'As per manufacturer',
    seo_title: 'EKTA Bullet Block Game 400 Pieces | Building Blocks | Khandelwal Toy Store',
  ...
  },
  {
    ...
    warranty: 'As per manufacturer',
    seo_title: 'EKTA Smart Builders Set-3 75 Large Blocks | Khandelwal Toy Store',
    seo_description: 'EKTA Smart Builders 75-piece big multicolour block set for kids 3+.',
    seo_keywords: JSON.stringify(['EKTA', 'Smart Builders', 'large blocks', 'preschool', 'toy store']),
  },
  {
    ...
    warranty: 'As per manufacturer',
    seo_title: 'EKTA Young Builders Set-1 Blocks & Bricks | Khandelwal Toy Store',
  ...
  },
  {
    ...
    warranty: 'As per manufacturer',
    seo_title: 'Fashion Villa Dress Decorate Dream Doll House | Khandelwal Toy Store',
